  ...
  return <div className="app-shell">
    ...
    <div className="workspace">
      <aside className="rail" aria-label="主要功能">
        {[["文", "作品"], ["卡", "創作卡牌"], ["綱", "大綱"], ["線", "關係圖"], ["搜", "搜尋"], ["設", "設定"]].map(([icon, label], index) => <button key={label} className={index === 0 ? "rail-item rail-item--active" : "rail-item"} aria-label={label} title={label}><span aria-hidden="true">{icon}</span></button>)}
      </aside>
