...
export function WorkspaceApp({ gateway }: { gateway: LibraryGateway }) {
  ...
  const [activeTool, setActiveTool] = useState<"works" | "cards" | "graph" | "outline" | "settings">("works");
  ...
  return <div className="app-shell">
    ...
    <div className="workspace">
      ...
      {activeTool === "cards" ? <CardWorkspace workId={activeWorkId} gateway={gateway} onError={setError} /> : activeTool === "graph" ? <GraphWorkspace workId={activeWorkId} gateway={gateway} onError={setError} /> : activeTool === "outline" ? <OutlineWorkspace workId={activeWorkId} gateway={gateway} onError={setError} onStructureChanged={refreshStructure} /> : activeTool === "settings" ? <SettingsWorkspace gateway={gateway} onError={setError} /> : <main className="editor-pane">
        {activeChapter ? <>
